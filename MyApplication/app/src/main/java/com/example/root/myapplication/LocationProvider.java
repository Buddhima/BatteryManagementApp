...
/**
 * Refer : http://www.tutorialspoint.com/android/android_content_providers.htm
 *
 */
...
public class LocationProvider extends ContentProvider {
    ...
    static final String ADDRESS = "Sample Address";
    static final String LONGITUDE = "0.0";
    static final String LATITUDE = "0.0";
